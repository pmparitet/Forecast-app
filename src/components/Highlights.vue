<template>
    <div class="section highlights">
        <div class="title">Основные показатели погоды на сегодня</div>
                        ...
                        <div class="card-justify">
                            <div class="info-main">
                                <div class="info-main-num">
                                    {{ weatherInfo?.wind?.speed ? weatherInfo?.wind?.speed : '-' }}
                                </div>
                                <div class="info-main-text">м/с</div>
                            </div>
                            <div class="info-main">
                                <div class="info-main-num">
                                    {{ weatherInfo?.wind?.deg ? weatherInfo?.wind?.deg : '-' }}
                                </div>
                ...
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        <div class="card-small-data">
                            <div class="info-main-num">
                                {{ weatherInfo?.wind?.gust ? Math.round(weatherInfo?.wind?.gust) : '0' }}
                            </div>
                            <div class="info-main-text">м/с</div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-info">
                        <div class="card-centered">
                            <div class="info-main">
                                <div class="info-main-num">
                                    {{ weatherInfo?.main?.pressure ? getPressureMm(weatherInfo?.main?.pressure) : '-' }}
                                </div>
                                <div class="info-main-text">мм</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        ...
                        <div class="card-small-hint">
                            ...
                            <div class="card-small-text">Какая температура на самом деле</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="highlight">
                ...
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        <div class="card-small-data">
                            <div class="info-main-num">
                                {{ weatherInfo?.clouds?.all ? weatherInfo?.clouds?.all : '-' }}
                            </div>
...
const sunriseTime = computed(() => {
    return getTime(weatherInfo.value?.sys?.sunrise + weatherInfo.value?.timezone);
});

const sunsetTime = computed(() => {
    return getTime(weatherInfo.value?.sys?.sunset + weatherInfo.value?.timezone);
});
</script>
