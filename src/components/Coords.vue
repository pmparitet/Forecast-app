            ...
            <div class="block-bottom-inner">
                ...
                <div class="block-bottom-texts">
                    <div class="block-bottom-text-block">
                        <div class="block-bottom-text-block-title">Долгота: {{ coord ? coord.lon : '-' }}</div>
                        <div class="block-bottom-text-block-desc">
                            Долгота измеряет расстояние к востоку или западу от нулевого меридиана.
                        </div>
                    </div>
                    <div class="block-bottom-text-block">
                        <div class="block-bottom-text-block-title">Широта: {{ coord ? coord.lat : '-' }}</div>
                        <div class="block-bottom-text-block-desc">
                            Линии широты начинаются на экваторе (0 градусов широты) и проходят на восток и запад,
